      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="p-6 bg-surface border border-border rounded-lg">
            ...
            <div className="text-3xl font-bold">{stats?.torrents ?? '-'}</div>
          </div>
          <div className="p-6 bg-surface border border-border rounded-lg">
            <div className="text-sm text-text-secondary">Active peers</div>
            <div className="text-3xl font-bold">{stats?.activePeers ?? '-'}</div>
          </div>
        </div>
      </div>
    </div>
